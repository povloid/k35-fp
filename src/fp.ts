 ...
 * @param fn 
 */
export function curryAsTailAndFirst<R>(fn: () => R): () => R;
export function curryAsTailAndFirst<T1, R>(fn: (arg1: T1) => R): (arg1: T1) => R;
export function curryAsTailAndFirst<T1, T2, R>(fn: (arg1: T1, arg2: T2) => R): (arg2: T2) => (arg1: T1) => R;
export function curryAsTailAndFirst<T1, T2, T3, R>(fn: (arg1: T1, arg2: T2, arg3: T3) => R): (arg2: T2, arg3: T3) => (arg1: T1) => R;
export function curryAsTailAndFirst<T1, T2, T3, T4, R>(fn: (arg1: T1, arg2: T2, arg3: T3, arg4: T4) => R): (arg2: T2, arg3: T3, arg4: T4) => (arg1: T1) => R;
export function curryAsTailAndFirst<T1, T2, T3, T4, T5, R>(fn: (arg1: T1, arg2: T2, arg3: T3, arg4: T4, arg5: T5) => R): (arg2: T2, arg3: T3, arg4: T4, arg5: T5) => (arg1: T1) => R;
export function curryAsTailAndFirst<T1, T2, T3, T4, T5, T6, R>(fn: (arg1: T1, arg2: T2, arg3: T3, arg4: T4, arg5: T5, arg6: T6) => R): (arg2: T2, arg3: T3, arg4: T4, arg5: T5, arg6: T6) => (arg1: T1) => R;
export function curryAsTailAndFirst(fn: Function) {
